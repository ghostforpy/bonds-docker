...
MIGRATION_MODULES = {"sites": "bonds.contrib.sites.migrations"}
...
AUTHENTICATION_BACKENDS = [
    ...
    "tgbot.auth.auth_backends.TelegramChatAuthBackend",
]
...
MIDDLEWARE = [
    ...
    "tgbot.auth.middleware.AuthenticationTelegramChatMiddleware",  # auth by chat_id in telegram
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "bonds.utils.context_processors.settings_context",
            ],
        },
    }
]
