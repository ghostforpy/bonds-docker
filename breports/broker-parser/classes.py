...
from parsers import FileNotSupported, WrongParser
...
if __name__ == '__main__':
    filename1 = 'broker_reports/broker-report1.xlsx'
    filename2 = 'broker_reports/broker-report2.xlsx'
    broker_report1 = BrokerReport(TinkoffParserXLS, filename1)
    broker_report2 = BrokerReport(TinkoffParserXLS, filename2)
    b = broker_report2 # + broker_report2
    #data = b.securities_movement
    #print(b.period)
    #print(b.return_profit_and_taxes_sell_bonds_by_secid_isin('LKOH', since=date(day=19, month=3, year=2020)))
    print(b.all_profit_and_taxes_sell_bonds())
